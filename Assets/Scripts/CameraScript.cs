...
public class CameraScript : MonoBehaviour
{
    ...
    private void UpdateCameraObjectVisibiliy()
    {
        ...
        if (IsExteriorView)
        {
            ...
            {
                hackDisableShadowsObject.GetComponent<Renderer>().castShadows = true;
            }
        }
        else
        {
            ...
            foreach (var hackDisableShadowsObject in HackDisableShadowsObjects)
            {
                hackDisableShadowsObject.GetComponent<Renderer>().castShadows = false;
            }
        }
    }
    ...
    public void FixedUpdate()
	{
        ...
        player.gameObject.FindChild("PlayerHit").GetComponent<Collider>().enabled = false;
        ...
        player.gameObject.FindChild("PlayerHit").GetComponent<Collider>().enabled = true;	
	}
